...
const pillars = [
  { icon: Database, title: 'Security Data Platforms', desc: 'SIEM/SOAR engineering, ETL pipelines, and security analytics.' },
  { icon: ClipboardCheck, title: 'Compliance', desc: 'SOC 2, HIPAA, NIST, and CMMC — done right.' },
  { icon: BrainCircuit, title: 'AI Security', desc: 'LLM hardening, red teaming, and AI governance.' },
  { icon: Users, title: 'Professional Services', desc: 'vCISO, incident response, and security training.' },
]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {pillars.map(({ icon: Icon, title, desc }) => (
            <Link to="/services" key={title} className="group">
